...
async function vizualizarInformacoesGlobais() {
    ...
    paragrafo.innerHTML = 
                ...
                <br>Os dados revelam que <span>${pessoasPraticam}</span> bilhões de pessoas dedicam parte do seu tempo livre à prática regular de atividades físicas, representando quase metade da população mundial. Em média, essas pessoas investem <span>${dados.tempo_medio_semana_praticando_esportes}</span> horas por semana em esportes.
